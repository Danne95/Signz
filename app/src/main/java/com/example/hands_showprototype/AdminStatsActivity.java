...
public class AdminStatsActivity extends AppCompatActivity {
    ...
    private String[] statsNames={"GoToAdmin","GoToDeleteUser","GoToDemote","GoToTranslate","GoToLearn","GoToSupportQ","GoToSupporter","GoToSupportersStats","GoToUsersStats"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task = db.document("userstats/statsforadmin").get();//Retrieves document statsforadmin from firestore.
